...
export const metadata = {
  ...
  title: "About Lam Aesthetics Clinic | Trusted Skin & Aesthetic Experts in Leeds UK",
};
    ...
    <>
      ...
      <div className='h-[272px] lg:h-[330px] text-center flex items-center flex-1'>
        <div className='sm:w-3/4 md:w-1/2 mx-auto p-3 rounded-md'>
          ...
          <p className='text-justify'>I am a dedicated aesthetics clinician with over 29 years of experience as a medical doctor and 6 years specialising in aesthetics medicine. My approach combines medical expertise with an eye for natural beauty, delivering safe, effective, and tailored treatments. I take pride in achieving consistently excellent results and building long-term trust with my clients.</p>
        </div>
      </div>
    </>
  )
