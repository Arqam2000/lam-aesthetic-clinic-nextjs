      ...
      <div className="relative w-full mx-auto mt-4">
        ...
        >
          <Image
            ...
            alt={`Skin Care Aesthetics Clinic Leeds UK ${currentIndex + 1}`}
            layout="fill"
            objectFit="cover"
            loading="eager"
            fetchPriority="high"
